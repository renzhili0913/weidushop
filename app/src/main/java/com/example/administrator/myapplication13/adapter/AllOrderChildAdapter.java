...
public class AllOrderChildAdapter extends RecyclerView.Adapter<AllOrderChildAdapter.ViewHolder> {

    private Context context;
    private List<OrderShopBean.OrderListBean.DetailListBean> list;

    public AllOrderChildAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fragment_all_order_child_view, viewGroup, false);
