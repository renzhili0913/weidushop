...
public class PaymentderAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {

    private Context context;
    private List<OrderShopBean.OrderListBean> list;

    public PaymentderAdapter(Context context) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fragment_payment_param_view, viewGroup, false);
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder viewHolder, int i) {
       ...
       myViewHolder.expressSn.setText(list.get(i).getOrderId());
        //转换为时间格式并赋值
    ...
    private void getItewView(MyViewHolder myViewHolder,int i) {
        ...
        myViewHolder.childRecyclerview.setAdapter(paymentChildAdapter);
