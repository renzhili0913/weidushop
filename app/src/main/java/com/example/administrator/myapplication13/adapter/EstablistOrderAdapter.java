...
public class EstablistOrderAdapter extends RecyclerView.Adapter<EstablistOrderAdapter.ViewHolder> {

    private Context context;
    private ArrayList<CartBean.ResultBean> list;

    public EstablistOrderAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(ArrayList<CartBean.ResultBean> data) {
        list.clear();
        if (data != null) {
            list.addAll(data);
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fragment_establist_order_view, viewGroup, false);
