...
public class HomeHeatAdapter extends RecyclerView.Adapter<HomeHeatAdapter.ViewHolder> {

    private Context context;
    private List<ShopBean.ResultBean.RxxpBean.CommodityListBean> list;

    public HomeHeatAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<ShopBean.ResultBean.RxxpBean.CommodityListBean> data) {
        list.clear();
        if (data != null) {
            list.addAll(data);
        }
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fragment_home_head_view, viewGroup, false);
