...
public class PaymentFragment extends BaseFragment implements IView {
    ...
    private PaymentderAdapter paymentderAdapter;
    ...
    private void getRecyclerView() {
        ...
        //创建适配器
        paymentderAdapter = new PaymentderAdapter(getActivity());
        allRecyclerview.setAdapter(paymentderAdapter);
        //取消订单
        paymentderAdapter.setOnClickListener(new PaymentderAdapter.Click() {
            @Override
        ...
        //去支付
        paymentderAdapter.setPaymentClickListener(new PaymentderAdapter.PaymentClick() {
            @Override
    ...
    public void showRequeryData(Object o) {
        if (o instanceof OrderShopBean) {
            ...
            if (orderShopBean == null || !orderShopBean.isSuccess()) {
                ...
                if (mpage==1) {
                    paymentderAdapter.setList(orderShopBean.getOrderList());
                }else{
                    paymentderAdapter.addList(orderShopBean.getOrderList());
                }
            ...
            paymentderAdapter.deleteOrder(position );
