...
public class PaymentChildAdapter extends RecyclerView.Adapter<PaymentChildAdapter.ViewHolder> {

    private Context context;
    private List<OrderShopBean.OrderListBean.DetailListBean> list;

    public PaymentChildAdapter(Context context) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater.from(context).inflate(R.layout.adapter_fragment_payment_child_view, viewGroup, false);
