...
public class LabelSearchShopAdapter extends RecyclerView.Adapter<LabelSearchShopAdapter.ViewHolder> {
    private Context context;
    private List<LabelStopBean.ResultBean> list;

    public LabelSearchShopAdapter(Context context) {
        this.context = context;
        list = new ArrayList<>();
    }

    public void setList(List<LabelStopBean.ResultBean> data) {
        list.clear();
        if (data != null) {
            list.addAll(data);
        }
